<tr valign="top" id="packing_options">
    ...
    <a href="#" class="button plus getservicios"><?php _e( 'Obtener Servicios', 'wc_wanderlust' ); ?></a>
    <div id="order_sucursal_main_result"></div>
					...
					if ( $this->instance_settings['services'] ) {
						foreach ( $this->instance_settings['services'] as $key => $box ) {
							...
							<tr>
								...
								<td><input class="operativa" type="number" name="service_operativa[<?php echo $key; ?>]" value="<?php echo $box['operativa']; ?>" /> </td>
			 ...
			 jQuery('#woocommerce_oca_wanderlust_ajuste_precio').keydown(function (e) {
				...
				jQuery('.wanderlust_boxes .insert').click( function() {
					...
					var code = '<tr class="new">\
							...
							<td><input type="number" name="service_operativa[' + size + ']" /></td>\
				...
				jQuery('.getservicios').click( function(e) {
          e.preventDefault();
